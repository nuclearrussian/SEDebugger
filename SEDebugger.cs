...
/// <summary>
/// A wrapper class for <see cref="Debugger"/>.
/// 
/// Just place this class in your project then use SEDebugger anywhere you would have used <see cref="Debugger"/>
/// </summary>
static class SEDebugger
{
    /// <summary>
    /// Returns true if the preprocessor variable MOD_DEBUGGER_ACTIVE is defined.
    /// </summary>
    public static bool SEDebuggerActive
    {
        get
        {
